...
const STEPS = [
  ...
  },
  {
    ...
    subtitle: 'English · Hindi · Tamil',
    desc: 'Our NLP layer automatically identifies the language and switches to the appropriate linguistic model. Indian code-mixed content (Hinglish, Tanglish) is handled with specialized tokenizers.',
    color: '#22D3EE',
